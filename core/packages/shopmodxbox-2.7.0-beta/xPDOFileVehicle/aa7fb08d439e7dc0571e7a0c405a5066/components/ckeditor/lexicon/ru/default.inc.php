...
$_lang['ui_ckeditor.insert_object_link'] = 'Вставить ссылку на объект';
$_lang['ui_ckeditor.insert_object_name'] = 'Вставить имя объекта';
$_lang['ui_ckeditor.insert_object'] = 'Вставить объект';