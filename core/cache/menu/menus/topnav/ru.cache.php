      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'permissions' => '',
            'namespace' => 'core',
            'action_controller' => 'controllers/mgr/orders/list',
            'action_namespace' => 'basket',
            'id' => 'Управление заказами',
            'children' => 
            array (
            ),
            'controller' => '',
          ...
          1 => 
          array (
            'text' => 'Групповой редактор',
            'parent' => 'Магазин',
            'action' => '88',
            'description' => 'Табличный редактор документов',
            'icon' => '',
            'menuindex' => 1,
            'params' => '',
            'handler' => '',
            'permissions' => 'shopmodxgroupedit',
            'namespace' => 'core',
            'action_controller' => 'controllers/mgr/',
            'action_namespace' => 'shopmodxgroupedit',
            'id' => 'Групповой редактор',
            'children' => 
            array (
            ),
            'controller' => '',
          ...
          array (
            'text' => 'Статусы',
            'parent' => 'Магазин',
            'action' => 'controllers/mgr/orderstatuses/',
            'description' => 'Управление статусами',
            'icon' => '',
            'menuindex' => 2,
            'params' => '',
            'handler' => '',
            'permissions' => 'basket.statuses',
            'namespace' => 'basket',
            'action_controller' => NULL,
            'action_namespace' => NULL,
            'id' => 'Статусы',
